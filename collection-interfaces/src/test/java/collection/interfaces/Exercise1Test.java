...
public class Exercise1Test extends ClassicOnlineStore {
    ...
    public void iterateByForEach() {
         ...
         */
//        Consumer<String> consumer = (c)->{nameList.add(c);}  ;
//        customerIterable.forEach((o)->consumer.accept(o.getName())));
    ...
    public void sortByName() {
         ...
         */
        Comparator<String> comparator = (p1, p2) -> (p1.length() >= p2.length())?0:-1;
