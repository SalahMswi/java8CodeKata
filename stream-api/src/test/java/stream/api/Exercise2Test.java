...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void top3RichCustomer() {
         ...
         */
        Comparator<Customer> customerComparator=Comparator.comparingInt(Customer::getBudget).reversed();

        Stream<String> top3RichCustomerStream = customerList.stream().sorted(customerComparator).map(Customer::getName).limit(3);
