...
public class Exercise7Test extends ClassicOnlineStore {
    ...
    public void averageAge() {
         ...
         */
        IntStream ageStream = customerList.stream().mapToInt(c->Integer.valueOf(c.getAge()));
    ...
    public void howMuchToBuyAllItems() {
         ...
         */
        LongStream priceStream = shopList.stream().flatMap(shop->shop.getItemList().stream())
